...
public class UserController {
	...
	@GetMapping("/paged")
	public ResponseEntity<Page<UserDto>> getPagedUsers(@RequestParam(defaultValue = "0") int page,
	...
	@Operation(summary = "Change user password", description = "Allows an authenticated user to change their password by providing the current password and a new one")
